...
{{--                <select id="category-select" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border-2">--}}
...
{{--                            <p--}}
{{--                               class="mt-2 text-lg font-bold text-indigo-600">{{ $product->formattedPrice() }}</p>--}}
{{--                        </div>--}}
{{--                    @endforeach--}}
{{--                @else--}}
...
{{--                    <select id="category-select" name="categoryId" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border-2">--}}
{{--                        <option value="">Choose a Category</option>--}}
{{--                        @foreach($categories as $category)--}}
