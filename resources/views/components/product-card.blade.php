...
{{--                        <img src="https://tailwindui.com/plus/img/ecommerce-images/product-page-03-related-product-01.jpg" alt="Front of zip tote bag with white canvas, black canvas straps and handle, and black zipper pulls."--}}
                    ...
                    <div class="absolute inset-x-0 top-0 flex h-72 items-end justify-end overflow-hidden rounded-lg p-4">
                        ...
                        <p class="relative text-lg font-bold text-indigo-600">{{ $product->formattedPrice() }}</p>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    @guest cursor-not-allowed opacity-50 @endguest @auth cursor-pointer active:text-gray-900 active:bg-gray-300 @endauth">Add to bag<span class="sr-only">, Zip Tote Basket</span></a>
                </div>
            </div>
        </div>
</div>
